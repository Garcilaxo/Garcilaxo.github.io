document.addEventListener("DOMContentLoaded", function() {
  ...
  if (dataJSON) {
      ...
      document.getElementById("color_slider1").slider = `background: linear-gradient(to right, rgb(56, 132, 232) ${data.influcard.insight_perc_13.toFixed(2)}%, rgb(216, 212, 212) 90.73%);`;
